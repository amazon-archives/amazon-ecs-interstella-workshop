...
- rebuild the image after you've reordered the instructions
- add another arbitrary comment to monolith.py
- rebuild the image again and notice dependencies are referenced from cache:
