...
* **Log options** - enter the name of the CloudWatch log group that CloudFormation created, and enter the AWS region of the log group. Enter **prod** as the awslogs-stream-prefix.
